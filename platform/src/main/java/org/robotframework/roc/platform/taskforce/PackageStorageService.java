...
@Service
public class PackageStorageService implements FileStorageService {
    ...
    public void save(MultipartFile file) {
        try {
            FileUtils.copyInputStreamToFile(file.getInputStream(), Paths.get(this.root.toString(), "roc.zip").toFile());
        } catch (Exception e) {
