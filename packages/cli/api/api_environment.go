...
/*
EnvironmentApiService Create new environment object
...
@return Environment
*/
func (a *EnvironmentApiService) CreateEnvironment(ctx context.Context, body interface{}, projectId string) (Environment, *http.Response, error) {
	var (
...
func (a *EnvironmentApiService) DeleteEnvironment(ctx context.Context, environmentId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/environment/{environmentId}"
...
/*
EnvironmentApiService List all environments by project id
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param projectId Id of project

@return []Environment
*/
func (a *EnvironmentApiService) GetEnvironments(ctx context.Context, projectId string) ([]Environment, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
