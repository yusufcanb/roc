...
// APIClient manages communication with the ROC (Robot Operation Center) API v2.0.0
...
type APIClient struct {
	...
	TaskForceApi *TaskForceApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.TaskForceApi = (*TaskForceApiService)(&c.common)
