...
ProjectApiService Create new project
  ...
  - @param body Project create body content

@return Project
*/
func (a *ProjectApiService) CreateProject(ctx context.Context, body interface{}) (Project, *http.Response, error) {
	var (
...
/*
ProjectApiService Get Project by Id
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param projectId Id of project
...
@return []Project
*/
func (a *ProjectApiService) GetProjects(ctx context.Context) ([]Project, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
