...
type TaskForceApiService service

/*
TaskForceApiService Create new task force
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body Task force create body content
  - @param projectId Id of project

@return TaskForce
*/
func (a *TaskForceApiService) CreateTaskForce(ctx context.Context, body interface{}, projectId string) (TaskForce, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/task-force"
...
func (a *TaskForceApiService) DeleteTaskForce(ctx context.Context, taskForceId []int32) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/task-force/{taskForceId}"
	localVarPath = strings.Replace(localVarPath, "{"+"taskForceId"+"}", fmt.Sprintf("%v", taskForceId), -1)
...
/*
TaskForceApiService List task forces
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param projectId Id of project

@return []TaskForce
*/
func (a *TaskForceApiService) GetTaskForces(ctx context.Context, projectId string) ([]TaskForce, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
